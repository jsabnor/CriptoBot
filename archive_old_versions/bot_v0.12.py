...
USE_ADX_FILTER = True  # Entra si ADX > 17
ADX_LENGTH = 14
ADX_THRESHOLD = 17  # Balanceado
USE_RSI_FILTER = True  # On para momentum
RSI_LENGTH = 14
RSI_THRESHOLD = 50  # Neutral
USE_VOLUME_FILTER = True  # Soft para hype
VOLUME_MA_LENGTH = 20
VOLUME_MULTIPLIER = 1.2  # Volume > 1.2 * MA
USE_TRAILING_TP = True  # Trailing take profit
TRAILING_TP_PERCENT = 0.80  # 80% para pumps
...
def simulate_strategy(df, initial_capital):
    ...
    for i in range(1, len(df)):
        ...
        if USE_VOLUME_FILTER:
            enter_cond = enter_cond and (volume > volume_ma * VOLUME_MULTIPLIER)
