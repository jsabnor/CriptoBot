...
ATR_LENGTH = 14
ATR_MULTIPLIER = 5.0  # Aumentado para volatilidad
...
LONG_MA_LENGTH = 200
USE_RSI_FILTER = True  # RSI >55 para entrada
RSI_LENGTH = 14
RSI_THRESHOLD = 55  # Menos restrictivo
USE_VOLUME_FILTER = True  # Activo para capturar pumps
VOLUME_MA_LENGTH = 20
USE_TRAILING_TP = True  # Trailing take profit
TRAILING_TP_PERCENT = 0.40  # 40% para pumps largos
