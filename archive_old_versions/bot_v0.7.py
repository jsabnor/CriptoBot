...
LONG_MA_LENGTH = 200
USE_TRAILING_SL_MA = True  # Nuevo: Salir si close < MA(50)
USE_RSI_FILTER = False  # Desactivado para más entradas
RSI_LENGTH = 14
RSI_THRESHOLD = 55
USE_VOLUME_FILTER = False  # Desactivado
VOLUME_MA_LENGTH = 20
USE_TRAILING_TP = True  # Trailing take profit
TRAILING_TP_PERCENT = 0.50  # 50% para pumps largos
...
def live_strategy():
    ...
    while True:
        limit = max(ATR_LENGTH, MA_LENGTH if USE_MA_FILTER or USE_TRAILING_SL_MA else 0, LONG_MA_LENGTH if USE_LONG_MA_EXIT else 0, RSI_LENGTH if USE_RSI_FILTER else 0, VOLUME_MA_LENGTH if USE_VOLUME_FILTER else 0) + 2
...
if __name__ == "__main__":
    if MODE == 'simulate':
        ...
        limit = days + max(ATR_LENGTH, MA_LENGTH if USE_MA_FILTER or USE_TRAILING_SL_MA else 0, LONG_MA_LENGTH if USE_LONG_MA_EXIT else 0, RSI_LENGTH if USE_RSI_FILTER else 0, VOLUME_MA_LENGTH if USE_VOLUME_FILTER else 0) + 10
