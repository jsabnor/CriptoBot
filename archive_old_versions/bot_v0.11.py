...
USE_ADX_FILTER = True  # Entra si ADX > 18
ADX_LENGTH = 14
ADX_THRESHOLD = 18  # Balanceado
USE_RSI_FILTER = False  # Desactivado
RSI_LENGTH = 14
RSI_THRESHOLD = 55
USE_VOLUME_FILTER = True  # Soft para hype
VOLUME_MA_LENGTH = 20
VOLUME_MULTIPLIER = 1.5  # Volume > 1.5 * MA
USE_TRAILING_TP = True  # Trailing take profit
TRAILING_TP_PERCENT = 0.90  # 90% para pumps extremos
